...
(function (factory) {
  ...
  var settings = {
    ...
    options: {
      ...
      // fontName
      fontNames: [
        'Arial', 'Arial Black', 'Comic Sans MS', 'Courier New', 'Great Vibes',
        'Helvetica Neue', 'Impact', 'Lato', 'Lobster', 'Lucida Grande', 'News Cycle', 'Open Sans',
        'Pacifico', 'Patua One', 'Playball', 'Pinyon Script', 'Poiret One', 'Sanchez', 'Tahoma', 'Times New Roman', 'Verdana'
      ],
      fontNamesIgnoreCheck: ['Great Vibes','Lato','Lobster','News Cycle','Open Sans','Pacifico','Patua One','Playball','Pinyon Script','Poiret One','Sanchez',],
      ...
      // lineHeight
      lineHeights: ['0.6', '0.8', '1.0', '1.2', '1.4', '1.5', '1.6', '1.8', '2.0', '3.0'],
  ...
  var Button = function () {
    ...
    this.update = function ($container, styleInfo) {
      ...
      // fontname
      var $fontname = $container.find('.note-font');
      if ($fontname.length) {
    ...
    var tplButtonInfo = {
      ...
      fontname: function (lang, options) {
        ...
        return tplButton(label, {
          ...
          dropdown: '<ul class="dropdown-menu mr-scrollableMenu">' + items + '</ul>'
        });
      },
      color: function (lang) {
        // var colorButtonLabel = '<i class="fa fa-font" style="color:black;background-color:yellow;"></i>';
        var colorButtonLabel = '<i class="fa fa-font" style="color:black;background-color:transparent;"></i>';
        var colorButton = tplButton(colorButtonLabel, {
          className: 'note-recent-color',
          title: lang.color.recent,
          event: 'color',
          // value: '{"backColor":"yellow"}'
          value: '{"backColor":"transparent"}'
        });
